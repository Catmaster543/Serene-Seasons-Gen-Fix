# ❓ What does this mod (and branch) do?
...
This branch has one purpose and one purpose only - it is the baseplate for the multiloader, which allows the mod to exist for forge, fabric and neoforge at the same time, without it having to be three separate projects.
